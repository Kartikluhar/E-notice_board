...
urlpatterns = [
    ...
    path('delete-all-notices/', views.delete_all_notices,
         name='delete_all_notices'),
    path('delete-expired-notices/', views.delete_expired_notices,
         name='delete_expired_notices'),
